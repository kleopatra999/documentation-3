...
`ClamAV`_ is the only _officially_ supported virus scanner available for use with ownCloud. 
It operates on all major operating systems, including Windows, Linux, and Mac; detects all forms of malware including Trojan horses, viruses, and worms; and can scan compressed files, executables, image files, Flash, PDF, as well as many others.
...
For example, to run it every hour at 47 minutes past the hour, add the following
in the applicable user's crontab:
